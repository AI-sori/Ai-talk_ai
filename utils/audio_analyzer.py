...
class AudioAnalyzer:
    ...
    def _get_realistic_dummy(self):
        """현실적인 더미 결과"""
        dummy_responses = [
            "이 책은 정말 재미있었어요. 주인공이 모험을 떠나는 이야기가 흥미로웠습니다.",
            "독서를 하면서 새로운 것들을 많이 배웠어요. 특히 등장인물들이 용감했습니다.",
            "책 내용이 이해하기 쉬웠고, 그림도 예뻤어요. 다음에도 이런 책을 읽고 싶습니다.",
            "이야기가 신기했어요. 주인공이 어려움을 극복하는 모습이 인상깊었습니다.",
            "독서는 상상력을 기를 수 있어서 좋아요. 책을 읽으면 다른 세상에 간 것 같아요."
        ]
